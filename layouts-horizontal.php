    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            <div class="page-container">
                ...
                <!-- @@include('./partials/page-title.php', {"subtitle":"Layout","title":"Horizontal"}) -->
                ...
                <div class="alert alert-info d-flex align-items-center d-none d-md-flex" role="alert">
                    ...
                    <p class="mb-0">
                        <strong> Dear Maxine - </strong> We kindly encourage you to review your recent transactions and
                        financial commitments to ensure that your account is in good standing.
                    </p>
                    <a href="#!" class="text-reset text-decoration-underline ms-auto link-offset-2">
                        <b>Action Now</b>
                    </a>
                </div>
