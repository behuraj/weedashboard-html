...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="multiple-radialbar" class="apex-charts" data-colors="#45bbe0,#f9bc0b,#777edd,#0acf97"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center" dir="ltr">
                                    <div id="circle-angle-radial" class="apex-charts" data-colors="#0acf97,#777edd,#fa5c7c,#f9bc0b"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="stroked-guage-radial" class="apex-charts" data-colors="#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="gradient-chart" class="apex-charts" data-colors="#8f75da,#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="semi-circle-gauge" class="apex-charts" data-colors="#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
    ...
    <script src="assets/js/components/chart-apex-radialbar.js"></script>
</body>
