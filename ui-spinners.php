                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the border spinners for a lightweight loading indicator.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">You can use any
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use flexbox utilities, float utilities, or text alignment
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Add <code>.spinner-border-sm</code> and
                                    <code>.spinner-border.avatar-**</code> to make a smaller spinner that can quickly be
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">If you don’t fancy a border spinner, switch to the grow spinner.
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">You can use any of our text color utilities on the standard
                                    spinner.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use <code>flexbox utilities</code>, <code>float utilities</code>,
                                    or <code>text alignment</code> utilities to place spinners exactly where you need
