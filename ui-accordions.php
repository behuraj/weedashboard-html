                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Click the accordions below to expand/collapse the accordion
                                    content.</p>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="CustomIconheadingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                <i class="ri-add-line accordion-icon accordion-icon-on"></i>
                                                <i class="ri-subtract-line accordion-icon accordion-icon-off"></i>
                                            </button>
                                        </h2>
                                        ...
                                        <h2 class="accordion-header" id="CustomIconheadingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <iconify-icon icon="solar:add-square-bold-duotone"
                                                    class="accordion-icon text-secondary accordion-icon-on fs-24 me-n2"></iconify-icon>
                                                <iconify-icon icon="solar:minus-square-bold-duotone"
                                                    class="accordion-icon text-danger accordion-icon-off fs-24 me-n2"></iconify-icon>
                                            </button>
                                        </h2>
