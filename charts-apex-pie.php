                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="simple-pie" class="apex-charts"
                                        data-colors="#777edd,#45bbe0,#0acf97,#fa5c7c,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="simple-donut" class="apex-charts"
                                        data-colors="#39afd1,#f9bc0b,#313a46,#fa5c7c,#0acf97"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="image-pie" class="apex-charts"
                                        data-colors="#39afd1,#f9bc0b,#777edd,#0acf97"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="update-donut" class="apex-charts"
                                        data-colors="#777edd,#45bbe0,#0acf97,#fa5c7c"></div>
                                </div>
