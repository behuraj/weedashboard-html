                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <div class="pt-3 pb-4">
                                            <div class="input-group">
                                                ...
                                                <button type="button"
                                                    class="input-group-text btn waves-effect waves-light btn-primary"><i
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="search-item">
                                                    <h4 class="mb-1"><a href="#">Highdmin - Responsive Admin Template</a>
                                                    </h4>
                                                    <div class="font-13 text-success mb-2 text-truncate">
                                                        http://coderthemes.com/highdmin/index.php
                                                    </div>
                                                ...
                                                <div class="search-item">
                                                    <h4 class="mb-1"><a href="#">Uplon - Responsive Bootstrap 5 Web App
                                                            Kit</a></h4>
                                                    <div class="font-13 text-success mb-2 text-truncate">
                                                ...
                                                <div class="search-item">
                                                    <h4 class="mb-1"><a href="#">Zircos - Responsive Admin Template</a>
                                                    </h4>
                                                    <div class="font-13 text-success mb-2 text-truncate">
                                                ...
                                                <div class="search-item">
                                                    ...
                                                    <div class="">
                                                        <img src="assets/images/small/small-1.jpg" height="48"
                                                            alt="image">
                                                        <img src="assets/images/small/small-2.jpg" height="48"
                                                            alt="image">
                                                        <img src="assets/images/small/small-3.jpg" height="48"
                                                            alt="image">
                                                        <img src="assets/images/small/small-4.jpg" height="48"
                                                            alt="image">
                                                    </div>
                                                </div> <!-- end search item -->
