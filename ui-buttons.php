                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <button type="button"
                                        class="btn btn-primary bg-gradient rounded-pill">Primary</button>
                                    <button type="button"
                                        class="btn btn-secondary bg-gradient rounded-pill">Secondary</button>
                                    <button type="button"
                                        class="btn btn-soft-success bg-gradient rounded-pill">Success</button>
                                    <button type="button"
                                        class="btn btn-soft-danger bg-gradient rounded-pill">Danger</button>
                                    <button type="button"
                                        class="btn btn-soft-warning bg-gradient rounded-pill">Warning</button>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <button type="button"
                                        class="btn btn-ghost-secondary rounded-pill">Secondary</button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <button type="button" class="btn btn-dark btn-icon">
                                        <i class="ri-sound-module-line fs-18"></i>
                                    </button>
                                    <button type="button" class="btn btn-soft-primary btn-icon">
                                        <iconify-icon icon="solar:add-circle-bold-duotone" class="fs-20"></iconify-icon>
                                    </button>
                                    <button type="button" class="btn btn-soft-success btn-icon">
                                        <i class="ri-spam-2-line fs-20"></i>
                                    </button>
                                    <button type="button" class="btn btn-info btn-icon">
                                        <i class="ri-car-line fs-18"></i>
                                    </button>
                                    <button type="button" class="btn btn-soft-warning btn-icon">
                                        <i class="ri-music-line fs-18"></i>
                                    </button>
                                    <button type="button" class="btn btn-light">
                                        <i class="ri-thumb-up-line align-middle me-1 fs-18"></i> Like
                                    </button>
                                    <button type="button" class="btn btn-outline-success">
                                        <i class="ri-wallet-2-line align-middle me-1 fs-18"></i> Money
                                    </button>
                                    <button type="button" class="btn btn-outline-primary">
                                        <i class="ri-paypal-line align-middle me-1 fs-18"></i> PayPal
                                    </button>
                                    <button type="button" class="btn btn-soft-danger">
                                        <iconify-icon icon="solar:settings-bold-duotone"
                                            class="fs-18 align-middle me-1"></iconify-icon>
                                        <span>Settings</span>
                                    </button>
                                </div>
                            </div> <!-- end card-body -->
