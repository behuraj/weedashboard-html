            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <form action="index.php" class="text-start mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="new-password">Create New Password <small class="text-info ms-1">Must be at least 8 characters</small></label>
                    ...
                    <p class="text-muted fs-14 mb-4">Back To <a href="auth-login.php" class="fw-semibold text-danger ms-1">Login !</a></p>
