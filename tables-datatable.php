                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    ...
                                    function:
                                    <code>$().DataTable();</code>. KeyTable provides Excel like cell navigation on any
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    ...
                                    and styling to display buttons on a page
                                    that will interact with a DataTable. The core library provides the based framework
                                    upon which plug-ins can built.
                                </p>
                                ...
                                <ul class="nav nav-tabs nav-bordered mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="#buttons-table-code" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link">
                                            Code
                                        </a>
                                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    ...
                                    buttons with
                                    up to 7 page numbers in-between)
                                    is fine for most situations, but there are cases where you may wish to
                                    customise the
                                    options presented to the end
                                    user.
                                </p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    ...
                                    direction.
                                    This can generally be seen as an
                                    alternative method to pagination for displaying a large table in a fairly
                                    small
                                    vertical area, and as such
                                    pagination has been disabled here (note that this is not mandatory, it will
                                    work
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    DataTables has the ability to show tables with horizontal scrolling, which
                                    is very
                                    useful for when you have a wide
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    Complex headers (using <code>colspan</code> / <code>rowspan</code>) can be
                                    used to
                                    group columns of similar information in DataTables, creating a very powerful
                                    visual
                                    effect.
                                </p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    ...
                                    row that is generated for display, the createdRow function is called once
                                    and once
                                    only. It is passed the create row
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    DataTables has the option of being able to save the state of a table (its
                                    paging
                                    position, ordering state etc) so
                                    that is can be restored when the user reloads a page, or comes back to the
                                    page
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted font-14">
                                    When making use of DataTables' x-axis scrolling feature you may wish to fix
                                    the left
                                    or right most columns in place
                                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-bordered mb-3">
                                    <li class="nav-item">
                                        <a href="#fixed-header-preview" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link active">
                                            Preview
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#fixed-header-code" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link">
                                            Code
                                        </a>
                                    </li>
