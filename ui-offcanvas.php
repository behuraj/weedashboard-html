                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop"
                                    ...
                                    <div class="offcanvas-header">
                                        <h4 class="offcanvas-title" id="offcanvasWithBackdropLabel">Offcanvas with
                                            backdrop</h4>
                                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                            aria-label="Close"></button>
                                    </div> <!-- end offcanvas-header-->
                                ...
                                <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                                    ...
                                    <div class="offcanvas-header">
                                        <h4 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Backdroped with
                                            scrolling</h4>
                                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                            aria-label="Close"></button>
                                    </div> <!-- end offcanvas-header-->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Change the appearance of offcanvases with utilities to better
                                    ...
                                    <code>.btn-close</code> for proper styling with a dark offcanvas. If you have
                                    dropdowns within, consider also adding
                                    <code>.dropdown-menu-dark</code> to <code>.dropdown-menu</code>.
                                </p>
                                <div>
                                    <button class="btn btn-primary mt-2 mt-md-0" type="button"
                                        data-bs-toggle="offcanvas" data-bs-target="#offcanvasDark"
                                        aria-controls="offcanvasDark">Dark offcanvas</button>
