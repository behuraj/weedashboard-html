...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="simple-candlestick" class="apex-charts" data-colors="#0acf97,#fa5c7c">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    ...
                                    <div id="combo-bar-candlestick" class="apex-charts" data-colors="#777edd,#f9bc0b">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="x-axis-candlestick" class="apex-charts"
                                        data-colors="#0acf97,#fa5c7c,#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="candlestick-with-line" class="apex-charts"
                                        data-colors="#777edd,#0acf97,#fa5c7c"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
    ...
    <script src="assets/js/components/chart-apex-candlestick.js"></script>
