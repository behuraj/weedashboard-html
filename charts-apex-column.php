...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-column" class="apex-charts" data-colors="#777edd,#0acf97,#fa5c7c">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="datalabels-column" class="apex-charts" data-colors="#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="stacked-column" class="apex-charts" data-colors="#39afd1,#f9bc0b,#e3eaef">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="full-stacked-column" class="apex-charts"
                                        data-colors="#39afd1,#0acf97,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="column-with-markers" class="apex-charts" data-colors="#777edd,#f9bc0b">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="negative-value-column" class="apex-charts" data-colors="#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="distributed-column" class="apex-charts"
                                        data-colors="#777edd,#45bbe0,#0acf97,#fa5c7c,#f9bc0b,#39afd1,#e3eaef,#313a46">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div dir="ltr">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div id="chart-year"
                                                data-colors="#777edd,#45bbe0,#0acf97,#fa5c7c,#f9bc0b,#39afd1"></div>
                                        </div>
                                        <div class="col-sm-6">
    ...
    <script src="assets/js/components/chart-apex-column.js"></script>
</body>
