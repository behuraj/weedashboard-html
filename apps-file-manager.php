                    ...
                    <div class="d-flex">
                                ...
                                <div class="p-3">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex justify-content-between gap-2 align-items-center mb-2">
                                            ...
                                            <button type="button"
                                                class="btn fw-medium btn-danger drop-arrow-none dropdown-toggle w-100">
                                                Create New <i class="ri-add-line ms-1"></i>
                                            </button>

                                            <button type="button"
                                                class="btn btn-icon btn-soft-danger ms-auto d-xl-none"
                                        ...
                                        <div class="file-menu">
                                            <a href="#" class="list-group-item active"><i
                                                    class="ri-folder-2-line fs-18 align-middle me-2"></i>My Files</a>
                                            <a href="#" class="list-group-item"><i
                                                    class="ri-drive-line fs-18 align-middle me-2"></i>Google Drive</a>
                                            <a href="#" class="list-group-item"><i
                                                    class="ri-share-line fs-18 align-middle me-2"></i>Share with me</a>
                                            <a href="#" class="list-group-item"><i
                                        ...
                                        <div class="mt-5 pt-5">
                                            <div class="alert alert-info p-3 pt-0 text-center mb-0" role="alert">
                                                <img src="assets/images/coffee-cup.svg" alt="" class="img-fluid mt-n5"
                                                    style="max-width: 135px;">
                                                <div>
                                                    <h5 class="alert-heading fw-medium fs-18 mt-2">Get more space for
                                                        files</h5>
                        ...
                        <div class="w-100 border-start">
                            <div class="p-3 d-flex align-items-center">
                                <button type="button" class="btn btn-light d-xxl-none d-flex p-1 me-2"
                                ...
                                <a href="#"
                                    class="ms-auto link-reset fw-medium text-decoration-underline link-offset-2">View
                                            ...
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="assets/images/users/avatar-1.jpg" download=""
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group flex-nowrap">
                                                    ...
                                                    <div class="avatar avatar-sm">
                                                        <span class="avatar-title bg-light rounded-circle fw-bold">
                                                            O
                                                        </span>
                                                    </div>
                                                    <div class="avatar avatar-sm">
                                            ...
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-link me-1"></i> Get Sharable Link</a>
                                                        <a href="assets/images/users/avatar-2.jpg" download=""
                                                            class="dropdown-item"><i class="ri-download-line me-1"></i>
                                                            Download</a>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-pushpin-2-line me-1"></i> Pin</a>
                                        ...
                                        <tr>
                                            ...
                                            <td id="tooltips-container">
                                                <div class="avatar-group flex-nowrap">
                                                    <div class="avatar avatar-sm">
                                                        <span
                                                            class="avatar-title bg-info rounded-circle fw-bold">S</span>
                                                    </div>
                                                    <div class="avatar avatar-sm">
                                                        <span
                                            ...
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-link me-1"></i> Get Sharable Link</a>
                                                        <a href="assets/images/users/avatar-3.jpg" download=""
                                                            class="dropdown-item"><i class="ri-download-line me-1"></i>
                                                            Download</a>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-pushpin-2-line me-1"></i> Pin</a>
                                        ...
                                        <tr>
                                            ...
                                            <td id="tooltips-container">
                                                <div class="avatar-group flex-nowrap">
                                                    <div class="avatar avatar-sm">
                                                        <span
                                                            class="avatar-title bg-danger rounded-circle fw-bold">J</span>
                                                    </div>
                                                    <div class="avatar avatar-sm">
                                                        <span
                                            ...
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-link me-1"></i> Get Sharable Link</a>
                                                        <a href="assets/images/users/avatar-4.jpg" download=""
                                                            class="dropdown-item"><i class="ri-download-line me-1"></i>
                                                            Download</a>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-pushpin-2-line me-1"></i> Pin</a>
                                            ...
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-link me-1"></i> Get Sharable Link</a>
                                                        <a href="assets/images/users/avatar-5.jpg" download=""
                                                            class="dropdown-item"><i class="ri-download-line me-1"></i>
                                                            Download</a>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-pushpin-2-line me-1"></i> Pin</a>
                                        ...
                                        <tr>
                                            ...
                                            <td id="tooltips-container">
                                                <div class="avatar-group flex-nowrap">
                                                    <div class="avatar avatar-sm">
                                                        <span
                                                            class="avatar-title bg-info rounded-circle fw-bold">C</span>
                                                    </div>
                                                    <div class="avatar avatar-sm">
                                                        <span
                                                            class="avatar-title bg-danger rounded-circle fw-bold">R</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-link me-1"></i> Get Sharable Link</a>
                                                        <a href="assets/images/users/avatar-6.jpg" download=""
                                                            class="dropdown-item"><i class="ri-download-line me-1"></i>
                                                            Download</a>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i
                                                                class="ri-pushpin-2-line me-1"></i> Pin</a>
