                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Simple pagination inspired by Rdio, great for apps and search
                                    results.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Change the alignment of pagination components with flexbox
                                    utilities.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Add <code> .pagination-lg</code> or <code> .pagination-sm</code>
