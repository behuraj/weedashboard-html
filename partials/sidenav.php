...
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="entrepreneurship.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-lightbulb-line"></i></span>
                    <span class="menu-text"> Entrepreneurship </span>
                </a>
            </li>

            <li class="side-nav-item">
                <a href="employment.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="education-skilling.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-book-open-line"></i></span>
                    <span class="menu-text"> Education & Skilling </span>
                </a>
            </li>

            <li class="side-nav-item">
                <a href="livelihood.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-hand-heart-line"></i></span>
                    <span class="menu-text"> Livelihood </span>
                </a>
            </li>

            <li class="side-nav-item">
                <a href="mobility-safety-infra.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-road-map-line"></i></span>
                    <span class="menu-text"> Mobility, Safety &<br>Inclusive Infra </span>
                </a>
            </li>

            <li class="side-nav-item">
                <a href="district-wise.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-map-pin-line"></i></span>
                    <span class="menu-text"> District wise </span>
                </a>
            </li>

            <li class="side-nav-item">
                <a href="department-wise.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="up-snapshot.php" class="side-nav-link">
                    <span class="menu-icon"><i class="ri-camera-line"></i></span>
                    <span class="menu-text"> UP Snapshot </span>
                </a>
            </li>
