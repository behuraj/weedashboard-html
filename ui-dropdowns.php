                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button class="btn btn-primary dropdown-toggle drop-arrow-none"
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button class="btn btn-outline-info dropdown-toggle drop-arrow-none"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                Tabler Icon <i class="ri-arrow-down-s-line align-middle ms-1"></i>
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button
                                                class="btn btn-secondary bg-gradient dropdown-toggle drop-arrow-none"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                Lucid Icon <i data-lucide="square-chevron-down"
                                                    class="avatar-xxs ms-2"></i>
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button class="btn btn-soft-success dropdown-toggle drop-arrow-none"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                Solar Icon <iconify-icon icon="solar:album-bold-duotone"
                                                    class="fs-20 ms-2"></iconify-icon>
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
