...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-area" class="apex-charts" data-colors="#f1556c"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="spline-area" class="apex-charts" data-colors="#777edd,#45bbe0"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="area-chart-negative" class="apex-charts" data-colors="#0acf97,#f9bc0b"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="stacked-area" class="apex-charts" data-colors="#777edd,#0acf97,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="area-timeSeries" class="apex-charts" data-colors="#39afd1,#fa5c7c,#777edd"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
    ...
    <script src="assets/js/components/chart-apex-area.js"></script>
</body>
