        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <p class="text-muted mb-4">We sent you a code, please enter it below to verify <br />your number <span class="text-primary fw-medium">+ (12) 345-678-912</span></p>
                    ...
                    <p class="text-muted fs-14 mb-4">Back To <a href="index.php" class="fw-semibold text-danger ms-1">Home!</a></p>
