                    ...
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 text-end">
                                        <img src="assets/images/png/qr-code.png" alt="qr-code-image" height="100">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table text-center table-nowrap align-middle mb-0">
                                        ...
                                        <tbody id="products-list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <iconify-icon icon="logos:openai-icon" class="fs-22"></iconify-icon>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <iconify-icon icon="logos:apple-app-store" class="fs-22"></iconify-icon>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <iconify-icon icon="logos:digital-ocean-icon" class="fs-22"></iconify-icon>
                                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-inline-block">
                                        <img src="assets/images/png/signature.png" alt="signature" height="32">
                        ...
                        <div class="d-print-none mb-5">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="javascript:window.print()" class="btn btn-primary"><i class="ri-printer-line me-1"></i> Print</a>
                                <a href="javascript: void(0);" class="btn btn-secondary"><i class="ri-send-plane-line me-1"></i> Send</a>
                                <a href="javascript: void(0);" class="btn btn-info"><i class="ri-download-line me-1"></i> Download</a>
                            </div>
                        </div>
                        <!-- end buttons -->
                    </div>
