    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="page-container">
                ...
                <div class="row" data-plugin="dragula" data-containers='["upcoming", "in-progress","completed"]'>
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="dropdown float-end">
                                    <a href="#" class="dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                ...
                                <div class="tasklist" id="upcoming">
                                    <div class="card" id="task1">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">iOS App home page</a></h5>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <p class="font-13 mt-2 mb-0"><i
                                                            class="ri-calendar-event-line me-1"></i> Oct 16, 2018</p>
                                                </div>
                                                <div class="col-auto">
                                                    <div class="text-end">
                                    ...
                                    <div class="card" id="task2">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Topnav layout design</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card" id="task3">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Invite user to a project</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-info" id="task4">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Write a release note</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                            <p>There are many variations of passages of Lorem Ipsum available.</p>
                                ...
                                <a href="javascript: void(0);" class="btn btn-primary w-100 mt-3 "><i
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="tasklist list-unstyled" id="in-progress">
                                    <div class="card" id="task6">
                                        <div class="card-body">
                                            <span class="badge bg-soft-warning text-warning float-end">Medium</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Enable analytics tracking</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-info" id="task7">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Kanban board design</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-danger" id="task8">
                                        <div class="card-body">
                                            <span class="badge bg-soft-success text-success float-end">Low</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Code HTML email template</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                            <p>There are many variations of passages of Lorem Ipsum available.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="tasklist list-unstyled" id="completed">
                                    <div class="card task-warning" id="task10">
                                        <div class="card-body">
                                            <span class="badge bg-soft-success text-success float-end">Low</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Brand logo design</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-success" id="task11">
                                        <div class="card-body">
                                            <span class="badge bg-soft-warning text-warning float-end">Medium</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Improve animation loader</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card" id="task12">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">Dashboard Re-design</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                            <p>There are many variations of passages of Lorem Ipsum available.</p>
                                    ...
                                    <div class="card task-info" id="task13">
                                        <div class="card-body">
                                            <span class="badge bg-soft-success text-success float-end">Low</span>
                                            <h5 class="mt-0"><a href="javascript: void(0);"
                                                    class="text-dark fw-semibold">iOS App home page</a></h5>
