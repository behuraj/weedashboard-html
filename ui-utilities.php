                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="p-2 mb-2 bg-danger bg-gradient text-white">.bg-danger.bg-gradient
                                </div>
                                <div class="p-2 mb-2 bg-warning bg-gradient text-dark">.bg-warning.bg-gradient
                                </div>
                                ...
                                <div class="p-2 mb-2 bg-black bg-gradient text-white">.bg-black.bg-gradient
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-column gap-2">
                                            <div class="bg-primary-subtle p-2"><code
                                                    class="text-primary-emphasis">.bg-primary-subtle</code>
                                            </div>
                                            ...
                                            <div class="bg-success-subtle p-2"><code
                                                    class="text-success-emphasis">.bg-success-subtle</code>
                                            </div>
                                            ...
                                            <div class="bg-warning-subtle p-2"><code
                                                    class="text-warning-emphasis">.bg-warning-subtle</code>
                                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Colorize text with color utilities. If you want to colorize links,
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-2">
                                    ...
                                    <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-circle"
                                        alt="rounded-circle">
                                    <img src="assets/images/small/small-2.jpg" class="avatar-lg w-auto rounded-pill"
                                        alt="rounded-pill">
                                </div>
