                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start justify-content-between mb-4">
                                        <div class="overflow-hidden position-relative border rounded d-flex align-items-center justify-content-start px-2"
                                            ...
                                            <img id="preview" src="assets/images/logo-dark.png" alt="Preview Image"
                                                height="28">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-sm-0 mt-3">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="text" data-provider="flatpickr" data-altFormat="F j, Y"
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2 pb-1">
                                                    <textarea type="text" id="BAddress" rows="3" class="form-control"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-start">
                                                            ...
                                                            <input type="text" id="product-desc-one"
                                                                class="form-control" placeholder="Item description">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="product-category-one"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start">
                                                            ...
                                                            <input type="text" id="product-desc-two"
                                                                class="form-control" placeholder="Item description">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="product-category-two"
                                                                class="form-control" placeholder="Quantity">
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control"
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control" id="InvoiceNote"
                                            placeholder="Thanks for your business " rows="3"></textarea>
                                    </div>
                                </div> <!-- end card-body-->
                            </form>
                        </div><!-- end card -->
                        <div class="mb-5">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="javascript:window.print()" class="btn btn-primary gap-1"><i
                                        class="ri-eye-line fs-16"></i> Preview</a>
                                <a href="javascript: void(0);" class="btn btn-success gap-1"><i
                                        class="ri-save-line fs-16"></i> Save</a>
                                <a href="javascript: void(0);" class="btn btn-info gap-1"><i
                                        class="ri-send-plane-fill fs-16"></i> Send Invoice</a>
                            </div>
                        </div>
                        <!-- end buttons -->
                    </div>
