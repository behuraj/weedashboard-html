            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <div class="mx-auto text-center">
                        <img src="assets/images/error/error-503.png" alt="error 503 img" height="230" class="mb-2">
                        ...
                        <p class="text-muted mb-3">The server is currently unable to handle the request due to temporary overload or maintenance. Please try again later.</p>
