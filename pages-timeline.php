                                    ...
                                    <div class="timeline-box">
                                        ...
                                        <div class="mt-2">
                                            <div class="d-flex justify-content-between">
                                                <p class="mb-2 text-dark fw-medium fs-16">Project Completed:
                                                    Achievements and Outcomes</p>
                                                <p class="mb-0">1hr Ago</p>
                                            </div>
                                            <p class="mb-1"><i
                                                    class="ri-check-line text-success me-1 fs-16"></i>Successfully met
                                                all project goals and objectives within the stipulated timeline.</p>
                                            <p class="mb-0"><i
                                                    class="ri-check-line text-success me-1 fs-16"></i>Delivered
                            ...
                            <div class="timeline-lg-item timeline-item-right">
                                <div class="timeline-desk">
                                    <div class="timeline-box">
                                        ...
                                        <p class="mb-2 text-dark fw-medium fs-16">Join as a full stack developers</p>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">html</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">CSS</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">JavaScript</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">NodeJS</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">ExpressJS</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">ExpressJS</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">Django</span>
                                        <span
                                            class="badge bg-light-subtle border text-dark fw-medium px-2 py-1 fs-12">MySQL</span>
                                        <span
                            ...
                            <div class="timeline-lg-item timeline-item-left">
                                <div class="timeline-desk">
                                    <div class="timeline-box">
                                        ...
                                        <div class="mt-2">
                                            <div class="d-flex justify-content-between">
                                                <p class="mb-2 text-dark fw-medium fs-16">Started Company Meeting</p>
                                                <p class="mb-0">2hr Ago</p>
                                            </div>
                                            <div class="d-flex flex-wrap align-items-center my-1 gap-1">
                                                <div class="avatar-group">
                                                    ...
                                                    <div class="avatar">
                                                        <div class="avatar-sm">
                                                            <span
                                                                class="avatar-title bg-dark text-white fs-18 rounded-circle">
                                            ...
                                            <p class="mb-0 mt-3 text-dark fw-semibold">Topic : <span
                                    ...
                                    <div class="timeline-box">
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <h4 class="text-dark mb-0 fw-medium"> New Admin Release In Bootstrap
                                                    <span
                                            ...
                                            <div class="timeline-album mb-3">
                                                <a href="javascript: void(0);">
                                                    <img src="assets/images/small/small-7.jpg" alt="" class="rounded-3">
                                                </a>
                                                <a href="javascript: void(0);">
                                                    <img src="assets/images/small/small-4.jpg" alt="" class="rounded-3">
                                                </a>
                                                <a href="javascript: void(0);">
                                                    <img src="assets/images/small/small-1.jpg" alt="" class="rounded-3">
                                                </a>
                                                <a href="javascript: void(0);">
                                                    <img src="assets/images/small/small-2.jpg" alt="" class="rounded-3">
                                                </a>
                                            </div>
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex align-items-center  gap-2 my-3">
                                                <img src="assets/images/users/avatar-5.jpg" alt=""
                                                    class="avatar-lg rounded-circle border border-light border-2">
                                                <div>
                                                    <h4 class="text-dark fw-medium"> Assigned to serve as the project's
                                                        director</h4>
                                                    <span class="text-dark"><small>by <a href="#!"
                                                                class="text-primary">John N. Ward.</a></small></span>
                                                </div>
                                                <div class="ms-auto">
                                                    <p class="mb-0">3hr Ago</p>
                                                </div>
                            ...
                            <div class="timeline-lg-item timeline-item-right">
                                <div class="timeline-desk">
                                    <div class="timeline-box">
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <h4 class="text-dark mb-0  fw-medium"> We have achieved 5.6k sales in
                                                    our themes.</h4>
                                                <p class="mb-0">1day Ago</p>
                                            </div>
                                            <p class="mb-0">As we celebrate this achievement, we remain focused on our
                                    ...
                                    <div class="timeline-box">
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h4 class="text-dark mb-0 fw-medium"> Website Launched</h4>
                                                    <p class="text-muted fw-medium fs-14 mt-1 mb-0"><span
                                                            class="text-dark">Name : </span> Ocen</p>
                                                </div>
                                            </div>
